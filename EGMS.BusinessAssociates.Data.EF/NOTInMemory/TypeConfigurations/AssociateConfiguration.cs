...
namespace EGMS.BusinessAssociates.Data.EF.NOTInMemory.TypeConfigurations
{
    class AssociateConfiguration : IEntityTypeConfiguration<Associate>
    {
        public void Configure(EntityTypeBuilder<Associate> builder)
        {
            ...
            builder.OwnsOne(associate => associate.DUNSNumber, cb => { cb.Property(e => e.Value).HasColumnName("DUNSNumber"); });
            builder.OwnsOne(associate => associate.ShortName, cb => { cb.Property(e => e.Value).HasColumnName("ShortName"); });
            builder.OwnsOne(associate => associate.LongName, cb => { cb.Property(e => e.Value).HasColumnName("LongName"); });
            ...
            builder.Property(associate => associate.StatusCode).HasColumnName("StatusCodeId");
        }
    }
}
